...
1. Create a folder inside the `lib/modules` which is located in `app_core` package. The name of the folder should be your
...
implementation of it by going into `packages/api_client/lib/src/api-failure.dart`.
:::
