  ...
  Widget wrappedRoute(BuildContext context) {
    return RepositoryProvider<HomeRepository>(
      ...
      child: BlocProvider<HomeBloc>(
        create:
            (context) => HomeBloc(repository: context.read<HomeRepository>()),
        child: this,
      ),
    );
  }
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              ...
              content: const AppText.regular10(
                text:
                    'We would like to send you notifications for important updates, alerts, and messages. Would you like to enable notifications?',
                maxLines: 4,
              ),
              actions: <Widget>[
                TextButton(
    ...
    showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const AppText.regular10(
            text:
                'Notifications are disabled. To receive important updates, alerts, and messages, please enable notifications in your device settings.',
          ),
          actions: <Widget>[
            TextButton(
      ...
      try {
        ...
        if (playerId.isNotEmpty) {
          ...
          if (mounted) {
            ...
            showAppSnackbar(context, 'Notification permission enabled.');
          }
        } else {
